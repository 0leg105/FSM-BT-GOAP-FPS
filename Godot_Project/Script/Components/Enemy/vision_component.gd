...
func _enter_tree() -> void:
	...
	look_at_component = character_body.get_look_at_component()
...
func _on_timer_timeout() -> void:
	state_manager.set_state("player_visible", false)
	timer.stop()

func set_player_visible(pos: Vector3) -> void:
	state_manager.set_state("player_visible", true)
	state_manager.set_state("last_seen_player_pos", pos)
